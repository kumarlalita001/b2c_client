...
import MSExcelSkill from "./MSExcelSkills.jsx";
...
function MSExcel() {
  ...
  const features = [
    {
      ...
      description:
        "Immerse yourself in our cutting-edge curriculum, meticulously designed to unleash your full potential with MS Excel.",
    },
    {
      icon: Laptop,
    ...
    },
    {
      ...
      description:
        "Navigate the world of MS Excel with confidence, guided by industry experts who are passionate about empowering your success.",
    },
    {
      icon: Medal,
  ...
  return (
    <><NavBar />
    <section className="relative overflow-hidden bg-black p-1 lg:ml-5">
        ...
        <div className="w-full min-h-[540px] bg-black">
          <div className="flex flex-col lg:flex-row w-full bg-black text-white relative md:p-[3rem] p-[1rem]">
            <div className="w-full">
              <h1 className="font-mullish text-5xl leading-14 md:leading-10 font-bold max-w-[600px]">
                Mastering Excel Online <br />
              </h1>
              <div className="mt-4">
                <p className="text-gold">
                  {" "}
                  Unlock the full potential of Microsoft Excel with our
                  comprehensive online course. Whether you're  <br/>a beginner looking
                  to learn the basics or an experienced user aiming to enhance
                  your skills, our<br/>course offers everything you need to excel in
                  Excel.{" "}
                </p>
              </div>
              ...
              <div className="space-y-6 mt-8">
                <div className="flex items-center gap-4">
                  ...
                  <p>Ready to revolutionize your MsExcel game?</p>
                </div>
                <div className="flex gap-4">
                  ...
                  <p>
                  Our MS Excel professionals are proficient in data analysis, modeling, and visualization.
                ...
                <div className="flex gap-4">
                  ...
                  <p>
                    {" "}
                    From financial modeling to data manipulation, our Excel experts have you covered.
                  </p>
                </div>
              </div>
              ...
              <div className="cursor-pointer">
                <div onClick={()=>navigate("/Register")}className="bg-goldenrod w-full md:w-fit hover:bg-goldenrod transition-all duration-200 hover:scale-105 hover:text-black text-white py-[14px] px-[18px] mt-4 rounded-md font-mullish font-bold text-center">
                  Join Now
